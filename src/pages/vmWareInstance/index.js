...
export default function VmwareInstance() {
  ...
  //     title: "Client",
  //     columnsRender: (row) => {
  //       return row.project?.updatedBy?.firstName;
  //     },
  //   },
  //   {
  //     key: "imageName",
  //     title: "Image Name",
  //     columnsRender: (row) => {
  //       return `${row?.operatingSystem?.operatingSystem?.name} ${row?.operatingSystem?.version}`;
  //     },
  //   },
  //   {
  //     key: "disk",
  ...
  //     columnsRender: (row) => {
  //       return `${row?.cpu}C${
  //         row?.memory > 10 ? `${row?.memory}MB` : `${row?.memory}GB`
  //       }${row?.storage}GB`;
  //     },
  //   },
  //   {
  ...
  //       return (
  //         <>
  //           <ActionVMWare data={row} refetch={refetch} />
  //         </>
  //       );
  //     },
  //   },
